...
env.PAYMENTS_PROVIDER = env.PAYMENTS_PROVIDER ?? "sandbox";
env.PAYMENTS_WEBHOOK_SECRET = env.PAYMENTS_WEBHOOK_SECRET ?? "test-payments-webhook-secret";
env.PAYMENTS_PLATFORM_FEE_BPS = env.PAYMENTS_PLATFORM_FEE_BPS ?? "1000";
env.LIVE_PROVIDER = env.LIVE_PROVIDER ?? "local";
env.AI_TIMEOUT_MS = env.AI_TIMEOUT_MS ?? "15000";
env.AI_MAX_RETRIES = env.AI_MAX_RETRIES ?? "1";
